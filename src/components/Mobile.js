      ...
      >
        ...
        <div className="h-[80%] w-full p-2 flex items-start justify-start flex-col overflow-hidden overflow-y-auto text-sm scroll my-2">
          ...
          <span
            ...
            value={"How to diagnose Parkinson's Disease?"}
            onClick={handleQuery}
          >
            <span className="flex gap-2 items-center justify-center text-base">
              <FiMessageSquare />
              <span className="text-sm">How to diagnose Parkinson's Disease?</span>
            </span>
          </span>
          <span
            ...
            value={"What are the common symptoms of PD?"}
            onClick={handleQuery}
          >
            <span className="flex gap-2 items-center justify-center text-base">
              <FiMessageSquare />
              <span className="text-sm">What are the common symptoms of PD?</span>
            </span>
          </span>
        </div>
        {/* bottom section  */}
